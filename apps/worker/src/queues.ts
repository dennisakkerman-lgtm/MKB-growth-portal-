...
export type SyncGscJob = { accountId: string; propertyId: string };
export type SyncGa4Job = { accountId: string; propertyId: string };
export type BackfillJob = { accountId: string; propertyId: string; months?: number };
export type AnalyzeJob = { accountId: string };
